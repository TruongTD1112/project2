...
def build_resnet(model, input_shape, classes):
    if model == 'ResNet18':
        return ResNet18(input_shape, classes)

    elif model == 'ResNet34':
        return ResNet34(input_shape, classes)

    elif model == 'ResNet50':
        return ResNet50(input_shape, classes)

    elif model == 'ResNet101':
        return ResNet101(input_shape, classes)

    elif model == 'ResNet152':
        return ResNet152(input_shape, classes)

if __name__ == "__main__":
    model = build_resnet('ResNet18', input_shape=(48, 48, 3), classes=7)
    path = 'model/resnet18_imagenet.h5'
